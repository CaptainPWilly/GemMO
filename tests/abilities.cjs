...
(async()=>{
 ...
 assert.equal(a.worldCanTravel('camp','crossroads'),true);assert.equal(a.worldCanTravel('camp','gem-shop'),true);assert.equal(a.worldCanTravel('camp','item-shop'),true);assert.equal(a.worldCanTravel('camp','bandit-pass'),false);assert.equal(a.worldCanTravel('crossroads','rat'),true);assert.equal(a.worldCanTravel('crossroads','bandit-pass'),false);assert.equal(a.worldCanTravel('rat','bandit-pass'),false);assert.equal(a.WORLD_NODES.rat.encounter,'rat');assert.equal(a.WORLD_NODES['bandit-pass'].encounter,'bandit');a.setWorldClears(['rat']);assert.equal(a.worldCanTravel('rat','bandit-pass'),true);a.setWorldClears([]);
