...
(async()=>{
 ...
 assert.equal(a.worldCanTravel('camp','crossroads'),true);assert.equal(a.worldCanTravel('camp','bandit-pass'),false);assert.equal(a.worldCanTravel('crossroads','bandit-pass'),true);assert.equal(a.WORLD_NODES['bandit-pass'].encounter,'bandit');
